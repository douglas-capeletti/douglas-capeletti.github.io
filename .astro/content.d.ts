declare module 'astro:content' {
	...
	type DataEntryMap = {
		"about_en": Record<string, {
  id: string;
  body?: string;
  collection: "about_en";
  data: InferEntrySchema<"about_en">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
"about_pt": Record<string, {
  id: string;
  body?: string;
  collection: "about_pt";
  data: InferEntrySchema<"about_pt">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
"guides_en": Record<string, {
  id: string;
  body?: string;
  collection: "guides_en";
  data: InferEntrySchema<"guides_en">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
"guides_pt": Record<string, {
  id: string;
  body?: string;
  collection: "guides_pt";
  data: InferEntrySchema<"guides_pt">;
  rendered?: RenderedContent;
  filePath?: string;
}>;
