...
export const ui = {
  pt: {
    ...
    'tools.title': 'Ferramentas úteis para o dia a dia.',
    'tools.compensation_comparator': 'Comparador de Salários',
    'tools.compensation_comparator.clt': 'CLT',
    'tools.compensation_comparator.pj': 'PJ (Simples Nacional)',
    'tools.compensation_comparator.coop': 'Cooperado',
    'tools.target_liquidity': 'Meta de Liquidez Anual Alvo (R$)',
    'tools.target_liquidity_tip': 'Altere este valor para recalcular a média mensal necessária em cada modelo.',
    'tools.pj_tax_rate': 'Alíquota PJ Simples (%)',
    'tools.coop_admin_fee': 'Taxa Admin Cooperativa (%)',
    'tools.coop_vacation_days': 'Dias Úteis de Férias (Cooperado)',
    'tools.coop_pro_labore': 'Valor do Pró-Labore (Cooperado)',
    // About
    'pages.about': 'Sobre',
  ...
  en: {
    ...
    // Tools
    'pages.tools': 'Tools',
    'tools.title': 'Useful tools for everyday use.',
    'tools.compensation_comparator': 'Compensation Comparator',
    'tools.compensation_comparator.clt': 'CLT (Full-time Employee)',
    'tools.compensation_comparator.pj': 'PJ (Contractor)',
    'tools.compensation_comparator.coop': 'Cooperative Member',
    'tools.target_liquidity': 'Target Annual Liquidity (R$)',
    'tools.target_liquidity_tip': 'Change this value to recalculate the required monthly average for each model.',
    'tools.pj_tax_rate': 'PJ Simples Tax Rate (%)',
    'tools.coop_admin_fee': 'Coop Admin Fee (%)',
    'tools.coop_vacation_days': 'Vacation Days (Coop)',
    'tools.coop_pro_labore': 'Pro-Labore Value (Coop)',
    // About
    'pages.about': 'About',
